...
{
    [System.Serializable]
    public class AIActionsList : ReorderableArray<Action>
    {
    }
    [System.Serializable]
    public class AITransitionsList : ReorderableArray<Transition>
    {
    }
    ...
    public class State 
    {
        ...
        public virtual void SetBrain(StateMachine brain)
        {
            _brain = brain;
        }
        ...
        protected virtual void EvaluateTransitions()
        {
            ...
            for (int i = 0; i < Transitions.Count; i++) 
            {
                ...
                {
                    if (Transitions[i].Decision.CheckCondition())
                    {
